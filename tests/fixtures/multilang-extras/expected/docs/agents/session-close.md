...
After every successful coding session, agents must complete this workflow before
handing off.
...
7. Push a `feature/...`, `bugfix/...`, `docs/...`, or similar branch to the
   remote.
8. Create a PR, review it, merge it, then delete the PR branch.

## Commit Message Format

Use the master work title as the first line, then the Conventional Commit line:
...
Allowed common types: `feat`, `fix`, `docs`, `refactor`, `test`, `build`,
`ci`, `chore`.
