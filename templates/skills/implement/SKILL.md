...
5. If the task involves schema changes, read `.agentic-scaffold/docs/agents/migrations.md`.
6. Implement the smallest complete slice that satisfies the plan.
7. Run focused verification.
8. If `.agentic-scaffold/.agents/hooks/post-feature.md` exists, read and follow it.
